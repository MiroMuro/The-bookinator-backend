...
> = {
  ...
  createUser?: Resolver<
    ...
    RequireFields<
      ...
      "favoriteGenre" | "password" | "username"
    >
  >;
  editAuthor?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationEditAuthorArgs, "name" | "setBornTo">
  >;
  login?: Resolver<
...
> = {
  authorUpdated?: SubscriptionResolver<
    ResolversTypes["Author"],
    "authorUpdated",
    ParentType,
    ContextType
  >;
  bookAdded?: SubscriptionResolver<
    ResolversTypes["Book"],
    "bookAdded",
    ParentType,
    ContextType
